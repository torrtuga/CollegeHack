...
public class Friday extends Activity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initialize();
		alarmIntent = new Intent(Friday.this, AlarmReceiver.class);
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(Friday.this);
		eStart.setText(prefs.getString("key17", "default"));
		eStop.setText(prefs.getString("key18", "default"));
		eWifiStart.setText(prefs.getString("key19", "default"));
		eWifiStop.setText(prefs.getString("key20", "default"));
	...
	protected void onPause() {
		...
		super.onPause();
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(Friday.this);
		prefs.edit().putString("key17", eStart.getText().toString()).apply();
		prefs.edit().putString("key18", eStop.getText().toString()).apply();
		prefs.edit().putString("key19", eWifiStart.getText().toString()).apply();
		prefs.edit().putString("key20", eWifiStop.getText().toString()).apply();
	}
            ...
            TimePickerDialog tpd1 = new TimePickerDialog(this,
                    new TimePickerDialog.OnTimeSetListener() {
                        ...
                        public void onTimeSet(TimePicker view, int hourOfDay,
                            ...
                            pendingIntent = PendingIntent.getBroadcast(Friday.this, 0, alarmIntent, PendingIntent.FLAG_UPDATE_CURRENT);
                            alarmRepeat();
                            }
