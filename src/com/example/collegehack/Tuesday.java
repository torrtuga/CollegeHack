...
public class Tuesday extends Activity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initialize();
		alarmIntent = new Intent(Tuesday.this, AlarmReceiver.class);
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(Tuesday.this);
		eStart.setText(prefs.getString("key5", "default"));
		eStop.setText(prefs.getString("key6", "default"));
		eWifiStart.setText(prefs.getString("key7", "default"));
		eWifiStop.setText(prefs.getString("key8", "default"));
	...
	protected void onPause() {
		...
		super.onPause();
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(Tuesday.this);
		prefs.edit().putString("key5", eStart.getText().toString()).apply();
		prefs.edit().putString("key6", eStop.getText().toString()).apply();
		prefs.edit().putString("key7", eWifiStart.getText().toString()).apply();
		prefs.edit().putString("key8", eWifiStop.getText().toString()).apply();
	}
            ...
            TimePickerDialog tpd1 = new TimePickerDialog(this,
                    new TimePickerDialog.OnTimeSetListener() {
                        ...
                        public void onTimeSet(TimePicker view, int hourOfDay,
                            ...
                            pendingIntent = PendingIntent.getBroadcast(Tuesday.this, 0, alarmIntent, PendingIntent.FLAG_UPDATE_CURRENT);
                            alarmRepeat();
                            }
