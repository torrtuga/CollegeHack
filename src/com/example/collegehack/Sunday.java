...
public class Sunday extends Activity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initialize();
		alarmIntent = new Intent(Sunday.this, AlarmReceiver.class);
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(Sunday.this);
		eStart.setText(prefs.getString("key25", "default"));
		eStop.setText(prefs.getString("key26", "default"));
		eWifiStart.setText(prefs.getString("key27", "default"));
		eWifiStop.setText(prefs.getString("key28", "default"));
	...
	protected void onPause() {
		...
		super.onPause();
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(Sunday.this);
		prefs.edit().putString("key25", eStart.getText().toString()).apply();
		prefs.edit().putString("key26", eStop.getText().toString()).apply();
		prefs.edit().putString("key27", eWifiStart.getText().toString()).apply();
		prefs.edit().putString("key28", eWifiStop.getText().toString()).apply();
	}
            ...
            TimePickerDialog tpd1 = new TimePickerDialog(this,
                    new TimePickerDialog.OnTimeSetListener() {
                        ...
                        public void onTimeSet(TimePicker view, int hourOfDay,
                            ...
                            pendingIntent = PendingIntent.getBroadcast(Sunday.this, 0, alarmIntent, PendingIntent.FLAG_UPDATE_CURRENT);
                            alarmRepeat();
                            }
