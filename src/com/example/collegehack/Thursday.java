...
public class Thursday extends Activity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initialize();
		alarmIntent = new Intent(Thursday.this, AlarmReceiver.class);
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(Thursday.this);
		eStart.setText(prefs.getString("key13", "default"));
		eStop.setText(prefs.getString("key14", "default"));
		eWifiStart.setText(prefs.getString("key15", "default"));
		eWifiStop.setText(prefs.getString("key16", "default"));
	...
	protected void onPause() {
		...
		super.onPause();
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(Thursday.this);
		prefs.edit().putString("key13", eStart.getText().toString()).apply();
		prefs.edit().putString("key14", eStop.getText().toString()).apply();
		prefs.edit().putString("key15", eWifiStart.getText().toString()).apply();
		prefs.edit().putString("key16", eWifiStop.getText().toString()).apply();
	}
            ...
            TimePickerDialog tpd1 = new TimePickerDialog(this,
                    new TimePickerDialog.OnTimeSetListener() {
                        ...
                        public void onTimeSet(TimePicker view, int hourOfDay,
                            ...
                            pendingIntent = PendingIntent.getBroadcast(Thursday.this, 0, alarmIntent, PendingIntent.FLAG_UPDATE_CURRENT);
                            alarmRepeat();
                            }
