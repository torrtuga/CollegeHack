...
public class Saturday extends Activity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initialize();
		alarmIntent = new Intent(Saturday.this, AlarmReceiver.class);
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(Saturday.this);
		eStart.setText(prefs.getString("key21", "default"));
		eStop.setText(prefs.getString("key22", "default"));
		eWifiStart.setText(prefs.getString("key23", "default"));
		eWifiStop.setText(prefs.getString("key24", "default"));
	...
	protected void onPause() {
		...
		super.onPause();
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(Saturday.this);
		prefs.edit().putString("key21", eStart.getText().toString()).apply();
		prefs.edit().putString("key22", eStop.getText().toString()).apply();
		prefs.edit().putString("key23", eWifiStart.getText().toString()).apply();
		prefs.edit().putString("key24", eWifiStop.getText().toString()).apply();
	}
            ...
            TimePickerDialog tpd1 = new TimePickerDialog(this,
                    new TimePickerDialog.OnTimeSetListener() {
                        ...
                        public void onTimeSet(TimePicker view, int hourOfDay,
                            ...
                            pendingIntent = PendingIntent.getBroadcast(Saturday.this, 0, alarmIntent, PendingIntent.FLAG_UPDATE_CURRENT);
                            alarmRepeat();
                            }
