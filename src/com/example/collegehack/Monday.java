...
public class Monday extends Activity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initialize();
		alarmIntent = new Intent(Monday.this, AlarmReceiver.class);
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(Monday.this);
		eStart.setText(prefs.getString("key1", "default"));
		eStop.setText(prefs.getString("key2", "default"));
		eWifiStart.setText(prefs.getString("key3", "default"));
		eWifiStop.setText(prefs.getString("key4", "default"));
	...
	protected void onPause() {
		...
		super.onPause();
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(Monday.this);
		prefs.edit().putString("key1", eStart.getText().toString()).apply();
		prefs.edit().putString("key2", eStop.getText().toString()).apply();
		prefs.edit().putString("key3", eWifiStart.getText().toString()).apply();
		prefs.edit().putString("key4", eWifiStop.getText().toString()).apply();
	}
            ...
            TimePickerDialog tpd1 = new TimePickerDialog(this,
                    new TimePickerDialog.OnTimeSetListener() {
                        ...
                        public void onTimeSet(TimePicker view, int hourOfDay,
                            ...
                            pendingIntent = PendingIntent.getBroadcast(Monday.this, 0, alarmIntent, PendingIntent.FLAG_UPDATE_CURRENT);
                            alarmRepeat();
                            }
